...
{
  new (message_memory) nuri_msgs::msg::RobotState(_init);
}

void RobotState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nuri_msgs::msg::RobotState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[2] = {
  {
    ...
    offsetof(nuri_msgs::msg::RobotState, status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nuri_msgs::msg::RobotState, battery),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotState_message_members = {
  "nuri_msgs::msg",  // message namespace
  "RobotState",  // message name
  2,  // number of fields
  sizeof(nuri_msgs::msg::RobotState),
...
get_message_type_support_handle<nuri_msgs::msg::RobotState>()
{
  return &::nuri_msgs::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nuri_msgs, msg, RobotState)() {
  return &::nuri_msgs::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
