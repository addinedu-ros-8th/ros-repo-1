...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_dashboard.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-home.png);")
        ...
        self.verticalLayoutWidget = QWidget(parent=self.home)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 1151, 91))
        ...
        self.bot_list = QComboBox(self.verticalLayoutWidget)
        self.bot_list.setObjectName("bot_list")
        self.bot_list.addItem("")
        self.bot_list.addItem("")
        self.bot_list.addItem("")
        self.bot_list.setFont(font)
        self.bot_list.setAutoFillBackground(False)
        self.bot_list.setStyleSheet(u"background-color: rgb(33, 37, 43);")
        self.bot_list.setIconSize(QSize(16, 16))
        self.bot_list.setFrame(True)
        self.horizontalLayout_7.addWidget(self.bot_list)
        self.lbl_robot_status = QLabel(self.verticalLayoutWidget)
        self.lbl_robot_status.setObjectName("lbl_robot_status")
        self.horizontalLayout_7.addWidget(self.lbl_robot_status)
        self.lbl_battery = QLabel(self.verticalLayoutWidget)
        self.lbl_battery.setObjectName("lbl_battery")
        self.horizontalLayout_7.addWidget(self.lbl_battery)
        self.lbl_connected = QLabel(self.verticalLayoutWidget)
        self.lbl_connected.setObjectName("lbl_connected")
        self.horizontalLayout_7.addWidget(self.lbl_connected)
...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_widgets.setText(QCoreApplication.translate("MainWindow", u"Residents", None))
        self.btn_logs.setText(QCoreApplication.translate("MainWindow", u"Logs", None))
        self.btn_settings.setText(QCoreApplication.translate("MainWindow", u"Settings", None))
        self.lbl_robot_status.setText(QCoreApplication.translate("MainWindow", "<img src=':/icons/images/icons/standby.png', width='30' style='vertical-align: middle; margin-right:10px'>"
        "<span style='font-weight:bold; font-size:20px'; vertical-align: middel;>StandBy</span>"))
        self.lbl_battery.setText(QCoreApplication.translate("MainWindow", "<img src=':/icons/images/icons/standby.png', width='30' style='vertical-align: middle; margin-right:10px'>"
        "<span style='font-weight:bold; font-size:20px'; vertical-align: middel;>80%</span>"))
        ...
        self.bot_list.setItemText(0, QCoreApplication.translate("MainWindow", u"Nuri 1", None))
        self.bot_list.setItemText(1, QCoreApplication.translate("MainWindow", u"Nuri 2", None))
        self.bot_list.setItemText(2, QCoreApplication.translate("MainWindow", u"Nuri 3", None))
